...
public:
             ...
             CertesianFaceSide x_dw) const
  {
    ...
    double center_af = cell._current_iteration_source[group] + (2.0 * x_uw_af * abs_mu / cell._l_x);
    center_af /= (2.0 * abs_mu / cell._l_x) + p._g_total[group];
