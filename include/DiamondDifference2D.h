...
public:
             ...
             CertesianFaceSide y_dw) const override final
  {
    ...
    double center_af = cell._current_iteration_source[group] + (2.0 * x_uw_af * abs_mu / cell._l_x) + (2.0 * y_uw_af * abs_eta / cell._l_y);
    center_af /= (2.0 * abs_mu / cell._l_x) + (2.0 * abs_eta / cell._l_x) + p._g_total[group];
