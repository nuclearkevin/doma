...
def main():
  ...
  parser.add_argument('-g', type=int, dest='grp', required=True, help='The energy group to plot.')
  ...
  raw_flux = np.loadtxt(dir_path + "/" + input_name + "_g" + str(cli_args.grp) + "_flux.txt")
